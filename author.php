...
?>
<title>Autores | Easy Library Manager</title>
			...
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-md-2" align="right">
						<button type="button" id="addAuthor" class="btn btn-info" title="Add user"><span class="glyphicon glyphicon-plus">Agregar</span></button>
					</div>
				</div>
			</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">						
							...
							<div class="form-group">							
								...
								<input type="text" name="name" id="name" autocomplete="off" class="form-control" placeholder="Nombre de Autor"/>
