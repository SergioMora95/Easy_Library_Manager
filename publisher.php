...
?>
<title>Editoriales Libros | Easy Library Manager</title>
			...
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-md-2" align="right">
						<button type="button" id="addPublisher" class="btn btn-info" title="Add publisher"><span class="glyphicon glyphicon-plus">Agregar</span></button>
					</div>
				</div>
			</div>
				...
				<form method="post" id="publisherForm">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title"><i class="fa fa-plus"></i> Editar editorial</h4>
						</div>
						<div class="modal-body">						
							
							<div class="form-group">							
								<label for="publisher" class="control-label">Editorial</label>							
								<input type="text" name="name" id="name" autocomplete="off" class="form-control" placeholder="Nombre de editorial"/>
