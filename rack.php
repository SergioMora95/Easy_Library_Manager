...
?>
<title>Ubicación de libros | Easy Library Manager</title>
			...
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-md-2" align="right">
						<button type="button" id="addRack" class="btn btn-info" title="Add rack"><span class="glyphicon glyphicon-plus">Agregar</span></button>
					</div>
				</div>
			</div>
				...
				<form method="post" id="rackForm">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title"><i class="fa fa-plus"></i> Editar ubicación</h4>
						</div>
						<div class="modal-body">						
							
							<div class="form-group">							
								<label for="rack" class="control-label">Ubicaciones</label>							
								<input type="text" name="name" id="name" autocomplete="off" class="form-control" placeholder="Nombre de ubicación"/>
