...
class Publisher {	
	...
	public function listPublisher(){		
		...
		while ($publisher = $result->fetch_assoc()) { 				
			...
			$rows[] = '<button type="button" name="update" id="'.$publisher["publisherid"].'" class="btn btn-warning btn-xs update"><span class="glyphicon glyphicon-edit" title="Edit">Modificar</span></button>';
