...
class Category {	
	...
	public function listCategory(){		
		...
		while ($category = $result->fetch_assoc()) { 				
			...
			$rows[] = '<button type="button" name="update" id="'.$category["categoryid"].'" class="btn btn-warning btn-xs update"><span class="glyphicon glyphicon-edit" title="Edit">Modificar</span></button>';
