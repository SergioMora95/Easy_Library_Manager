...
class User {	
	...
	public function listUsers(){		
		...
		while ($user = $result->fetch_assoc()) { 				
			...
			$rows[] = $user['email'];	
			$rows[] = $user['role'];			
			$rows[] = '<button type="button" name="update" id="'.$user["id"].'" class="btn btn-warning btn-xs update"><span class="glyphicon glyphicon-edit" title="Edit">Modificar</span></button>';
