...
class Books {	
	...
	public function listBook(){		
		...
		while ($book = $result->fetch_assoc()) { 				
			...
			$rows[] = '<img src="images/'.$book['picture'].'" width="30" height="30">';
			...
			$rows[] = '<button type="button" name="update" id="'.$book["bookid"].'" class="btn btn-warning btn-sm update"><span class="glyphicon glyphicon-edit" title="Edit">Modificar</span></button>';
			$rows[] = '<button type="button" name="delete" id="'.$book["bookid"].'" class="btn btn-danger btn-sm delete" ><span class="glyphicon glyphicon-remove" title="Delete">Eliminar</span></button>';
			$records[] = $rows;
			$count++;
		}
