...
class Author {	
	...
	public function listAuthor(){		
		...
		while ($author = $result->fetch_assoc()) { 				
			...
			$rows[] = $author['status'];							
			$rows[] = '<button type="button" name="update" id="'.$author["authorid"].'" class="btn btn-warning btn-xs update"><span class="glyphicon glyphicon-edit" title="Edit">Modificar</span></button>';
